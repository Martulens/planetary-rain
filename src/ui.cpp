...
void UI::renderUI()
{
    ...
    if (ImGui::CollapsingHeader("Waves")){
        ...
        if (mPlanetParams.wavesEnabled){
            mPlanetParams.changes.wavesChanged |= ImGui::SliderFloat("Wave Height", &mPlanetParams.waveHeight, 0.0f, 0.5f);
            mPlanetParams.changes.wavesChanged |= ImGui::SliderFloat("Wave Length", &mPlanetParams.waveLength, 0.01f, 0.5f);
            mPlanetParams.changes.wavesChanged |= ImGui::SliderFloat("Wave Speed", &mPlanetParams.waveSpeed, 0.0f, 0.5f);
            mPlanetParams.changes.wavesChanged |= ImGui::SliderFloat("Wave Offset", &mPlanetParams.waveOffset, 0.0f, 2.0f);
        }
    }
